...
This log was last generated on Sun, 05 May 2024 15:16:43 GMT and should not be manually modified.
...
- Default ('') can now be used as authKey.
...
- Breaks: Rename valueTypes to componentTypes in entity queries. Rename Admin/PublishedValueType -> Admin/PublishedComponentType.
...
- Break: Rename adminSearchEntities->adminEntities, adminSampleEntities->adminEntitiesSample, publishedSearchEntities->publishedEntities, publishedSampleEntities->publishedEntitiesSample. Break: Remove apis for fetching entity history and publishing history. Break: Rename Admin/PublishedEntitiesQuery/Order to Admin/PublishedEntityQuery/Order. Feat: Add id to changelog event. Fix: Import path
...
- Support valueTypes filter in search queries.
...
- Filter admin search/sample on validity and status
...
- Breaks: Add Published prefix to EntityType, ValueType, QueryOrder. Rename searchEntities to publishedSearchEntities. Use scalar for Location. Switch from JSON to JSONObject scalar.
...
- Support unique index. Add publishedEntity()
