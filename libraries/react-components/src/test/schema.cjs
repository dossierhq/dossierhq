...
const schemaSpecification = {
  entityTypes: [
    {
      ...
      fields: [
        ...
        { name: 'stringMatchPattern', type: 'String', matchPattern: 'fooBarBaz' },
    ...
    },
    {
      ...
      fields: [
        { name: 'body', type: 'RichText' },
        {
          ...
          type: 'RichText',
          entityTypes: ['Bar'],
          richTextNodes: ['root', 'paragraph', 'text', 'linebreak', 'tab', 'entity'],
        },
        {
          name: 'bodyNested',
          type: 'RichText',
          valueTypes: ['NestedValueItem'],
          richTextNodes: ['root', 'paragraph', 'text', 'linebreak', 'tab', 'valueItem'],
        },
        {
          name: 'bodyNoInline',
          type: 'RichText',
          richTextNodes: ['root', 'paragraph', 'text', 'linebreak', 'tab'],
        },
      ],
    },
    {
  ...
  valueTypes: [
    ...
    },
    {
      ...
      adminOnly: false,
      fields: [
        { name: 'text', type: 'String', matchPattern: 'fooBarBaz' },
