...
- Support rename and delete field in schema editor. Fix bugs where dropdowns didn't work in dialogs.
...
- Tweak notifications and published list layout
- Bump minor
