    ...
    expect(searchAdminEntitiesQuery(context, undefined, undefined)).toMatchInlineSnapshot(`
      OkResult {
        "value": Object {
          ...
          "isForwards": true,
          "pagingCount": 25,
          "text": "SELECT e.id, e.uuid, e.type, e.name, e.updated, e.archived, e.never_published, e.latest_draft_entity_versions_id, e.published_entity_versions_id, ev.version, ev.data
    ...
    expect(
      ...
      OkResult {
        "value": Object {
          ...
          "isForwards": true,
          "pagingCount": 25,
          "text": "SELECT DISTINCT e.id, e.uuid, e.type, e.name, e.updated, e.archived, e.never_published, e.latest_draft_entity_versions_id, e.published_entity_versions_id, ev.version, ev.data
