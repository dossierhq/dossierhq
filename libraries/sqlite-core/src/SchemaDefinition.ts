...
// Make uuid and name nullable and add deleted_at, uuid_before_delete, name_before_delete columns
...
export const REQUIRED_SCHEMA_VERSION: number = /* @__PURE__ */ (() => VERSIONS.length - 1)();
