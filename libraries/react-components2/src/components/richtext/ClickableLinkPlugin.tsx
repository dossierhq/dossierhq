...
import { $isEntityLinkNode } from './EntityLinkNode.js';

interface Props {
  onEntityLinkClick: (reference: EntityReference) => void;
}

export function ClickableLinkPlugin({ onEntityLinkClick }: Props): JSX.Element | null {
  ...
  useEffect(() => {
    function handleClick(event: MouseEvent) {
      ...
      editor.update(() => {
        ...
        } else if ($isEntityLinkNode(maybeLinkNode)) {
