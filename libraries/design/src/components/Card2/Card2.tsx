...
Card2.HeaderDropdown = <TItem extends DropdownItem>({
  items,
  renderItem,
  onItemClick,
...
Card2.Content = ({ children }: CardContentProps) => {
  return (
    <div className={toSpacingClassName({ paddingHorizontal: 3, paddingVertical: 2 })}>
      {children}
    </div>
  );
};
