...
- Break: Rename Button.Group to ButtonGroup
...
- Improve tree-shaking. Enable Next.js server-side rendering
...
- Allow readonly items in dropdown
...
- Fix bugs where dropdowns didn't work in dialogs.
...
- Center dialogs. Add delete and user icons
- Bump minor
...
- Use overflow auto instead of scroll. Enable dropdowns in dialogs. Fix react warnings. Upgrade dependencies.
...
- Add LexicalTheme. Open dropdown in dialog in portals. Upgrade dependencies.
...
- Replace Temporal.Instant with Date. Upgrade dependencies. More settings for Text.
...
- Add disabled to SelectDisplay.Option
...
- Improvements to tag input and dropdown. Basic support for rich text. IconButton.toggled. More colors and icons.
...
- Support value/onChange for TextArea
...
- Use SVG in CSS icons (background-image)
...
- Change how import of icons are made to appease Next JS
...
- Add icons and spacing storybook pages
...
- Message and File components. Minor tweaks. Upgrade dependencies.
...
- Many new components to support entity and schema editor. Upgrade dependencies.
...
- Optimise by reacting to mouse down. Support scroll to top in Scrollable. Fix clicking of SVG in button.
