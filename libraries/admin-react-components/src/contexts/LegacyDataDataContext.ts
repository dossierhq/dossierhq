...
import type { AdminDataDataContextAdapter, DisplayAuthKey, EditorJsToolSettings } from '..';

//TODO remove file when migrated to AdminDataDataContext
...
export class LegacyDataDataContextValue {
...
export const LegacyDataDataContext = createContext<LegacyDataDataContextValue>({
  defaultContextValue: true,
} as unknown as LegacyDataDataContextValue);
LegacyDataDataContext.displayName = 'LegacyDataDataContext';
