...
export { EntityList2 } from './components/EntityList2/EntityList2';
...
export { useLoadSearchEntities } from './hooks/useLoadSearchEntities';
export { useLoadTotalCount } from './hooks/useLoadTotalCount';
