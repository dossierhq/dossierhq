...
- Break: Rename AppPublishedClient->AppPublishedDossierClient, AppPublishedExceptionClient->AppPublishedDossierExceptionClient
...
- Break: Use '' as detauld authKey and map authKeyPattern to type.
...
- Break: Rename AppAdminValueItem to AppAdminComponent
...
- Support valueTypes in search queries
...
- Support string fields with values
...
- Rename AllAdmin/PublishedEntities to AppAdmin/PublishedEntity
...
- Specify type for unique indexes

## 0.2.1
Wed, 08 Feb 2023 18:24:40 GMT
...
- Support schema aware clients. Upgrade dependencies.
...
- Skip null for published required fields. Upgrade dependencies.
...
- Use [] instead of Array when one type. Upgrade dependencies.
